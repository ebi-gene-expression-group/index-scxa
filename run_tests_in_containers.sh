...
docker run --net $DOCKER_NET \
    ...
    -t solr:8.7 bin/solr zk cp file:$SECURITY_JSON zk:/security.json -z $ZK_HOST:$ZK_PORT
...
BIOSOLR_REMOTE_JAR_PATH=/packages/solr-ontology-update-processor-1.2.jar
